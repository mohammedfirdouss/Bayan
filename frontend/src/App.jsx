...
export default function App() {
  ...
  useEffect(() => {
    function onHashChange() { setView(getViewFromHash()) }
  ...
  return (
    <div style={{ minHeight: '100vh' }}>
      ...
      {view === 'search'  && <main style={{ paddingTop: 64 }}><Search /></main>}
      {view === 'verify'  && <main style={{ paddingTop: 64 }}><Verify /></main>}
      {view === 'outline' && <main style={{ paddingTop: 64 }}><Outline /></main>}
    </div>
  )
}
