...
export default function Verify() {
  ...
  const statusInfo = result ? getStatusInfo(result.status ?? result.match_status) : null
      ...
      <div style={styles.inner}>
        ...
        <header style={styles.header}>
          ...
          <p style={styles.subtitle}>
            Confirm whether a verse citation is accurate, paraphrased, or not found in the corpus
          </p>
          <Ornament />
        </header>
        ...
        <form onSubmit={handleSubmit} style={styles.form} className="form-card" noValidate>
          ...
          <div style={styles.langRow}>
            ...
            <div style={styles.langToggle} role="group" aria-label="Select text language">
              <button
                type="button"
          ...
          <textarea
            ...
            style={{
              ...styles.textarea,
              fontFamily: lang === 'arabic' ? "'Amiri', serif" : "'DM Sans', sans-serif",
        ...
        {result && statusInfo && (
          <div style={styles.resultPanel}>
            {/* Status badge */}
            <div style={{ ...styles.statusBadge, background: statusInfo.bg, color: statusInfo.color }}>
...
function getLangBtnStyle(active) {
  return {
    ...
    border: 'none',
    cursor: 'pointer',
    fontFamily: active && "'Amiri', serif" ? "'Amiri', serif" : "'DM Sans', sans-serif",
    fontSize: 14,
